...
--
-- Host: localhost    Database: carmark
-- ------------------------------------------------------
...
CREATE TABLE `cars` (
  ...
  `vinCode` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `vinUrl` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `images` (
  ...
  CONSTRAINT `FK_images_cars` FOREIGN KEY (`carId`) REFERENCES `cars` (`id`)
...
CREATE TABLE `pages` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pages_name_key` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'carmark'
--
